 ...
 *
 * Used as a standalone splash when the app cannot yet display the main UI
 * (e.g. auth result still pending on cold start).
 */
@Composable
fun AuthLoadingScreen(message: String = "Authenticating...") {
    Box(
        modifier = Modifier
            .fillMaxSize()
            .appBackground(),
